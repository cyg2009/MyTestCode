...
function main() {
    ...
    docker run -v $(pwd):/go/src/github.com/cyg2009/MyTestCode -w="/go/src/github.com/cyg2009/MyTestCode" golang:1.9 go build --ldflags '-extldflags "-static"' -a -o funcRouter  
}
